export const content = {
  ...
  toolBlock: {
    ...
    restoredResultUnconfirmed: '仅恢复了历史工具调用，没有执行结果记录。无法据此判断命令仍在运行、已完成或被中断。',
  ...
  agent: {
    ...
    inputSteer: '调整方向',
    inputContinue: '继续',
    inputWaiting: '已暂停。发送内容将在当前消息链上继续。',
    inputRejected: '未加入队列，请保留文字重试；每条最多 4000 字符，最多 5 条，合计最多 12000 字符。',
    inputEnded: '任务正在收尾，请稍候。',
    inputRemove: '移除',
    inputAttachments: '当前插入仅支持文字，请先移除待发送附件。',
    inputAcceptedInterrupted: 'DeepSeek 已接收补充消息，但后续处理被中断。该消息不会重新入队或自动重发。',
    inputDeliveryUnknown: '补充消息已经发起发送，但未收到送达确认。请刷新对话确认；以下内容未自动重发，也未恢复到输入框：',
    activityPreparing: '正在准备下一步',
    activityRequesting: '等待模型回复',
    activityResponding: '正在接收模型回复',
    activityStopping: '已请求停止，等待当前执行结束',
    activityToolWait: '等待工具返回：{name}（{count} 项）',
    activityElapsed: '已等待 {seconds} 秒',
    stop: '停止',
    stopped: '已停止',
    step: 'Step {index}',
    streaming: 'streaming...',
